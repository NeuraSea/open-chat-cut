...
const roadmapItems: RoadmapItem[] = [
	{
		title: "Start",
		description:
			"This is where it all started. Repository created, initial project structure, and the vision for an accessible video editor built in public. [Check out the first tweet](https://x.com/mazeincoding/status/1936706642512388188) to see where it started.",
		status: {
			text: "Completed",
			type: "complete",
		},
...
export const metadata: Metadata = {
	...
	description:
		"See what's coming next for OpenCut - the source-available video editor that respects your privacy.",
	openGraph: {
		...
		>
			<div className="mx-auto flex max-w-4xl flex-col gap-16">
				...
				<GitHubContributeSection
					title="Want to help?"
					description="OpenCut is source-available and built with its community. Every contribution,
