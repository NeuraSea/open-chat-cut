...
export const metadata: Metadata = {
	title: "Blog - OpenCut",
	description:
		"Read the latest news and updates about OpenCut, the source-available video editor.",
	openGraph: {
		title: "Blog - OpenCut",
		description:
			"Read the latest news and updates about OpenCut, the source-available video editor.",
...
export default async function BlogPage() {
	...
	return (
		<BasePage
			title="Blog"
			description="Read the latest news and updates about OpenCut, the source-available video editor."
		>
