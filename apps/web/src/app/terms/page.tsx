...
export const metadata: Metadata = {
	...
	description:
		"OpenCut's Terms of Service. Transparent terms for our source-available video editor.",
	openGraph: {
		title: "Terms of Service - OpenCut",
		description:
			"OpenCut's Terms of Service. Transparent terms for our source-available video editor.",
	...
	return (
		...
		>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					OpenCut source code is available under the Business Source License
					1.1 and separate commercial terms:
				</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>Review our code to see exactly how we handle your data</li>
					<li>Evaluate and self-host OpenCut for non-production use</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					OpenCut is provided under its applicable source or commercial license.
