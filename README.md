...
Local-first, agentic, source-available video editing built on the OpenCut Classic
...
OpenChatCut modifications and new components are licensed under the
[Business Source License 1.1](LICENSE). Personal, non-commercial production use
